      ...
      *              and SALESREP name lookup loaded from a file
      ****************************************************************
       ...
       01  CUSTMAST-RECORD.
           ...
           05  CUST-ZIP                PIC 9(5).
           05  CUST-SALESREP           PIC 99.
           05  CUST-BRANCH             PIC 99.
           05  CUST-YTD-THIS-YEAR      PIC S9(6)V99.
           05  CUST-YTD-LAST-YEAR      PIC S9(6)V99.
           05  FILLER                  PIC X(1).
       ...
       01  SALESREP-TABLE.
           05  SALESREP-GROUP          OCCURS 100 TIMES
               ...
               10  SALESREP-NUMBER     PIC 9(2)   VALUE ZERO.
               10  SALESREP-NAME       PIC X(10)  VALUE SPACES.
       ...
       300-PREPARE-SALES-LINES.
           ...
           EVALUATE TRUE
              ...
              WHEN FIRST-RECORD-SWITCH = "Y"
                 ...
                 MOVE CUST-SALESREP TO OLD-SALESREP-NUMBER
                 MOVE CUST-BRANCH   TO OLD-BRANCH-NUMBER
              WHEN CUST-BRANCH > OLD-BRANCH-NUMBER
                 PERFORM 355-PRINT-SALESREP-LINE
                 PERFORM 360-PRINT-BRANCH-LINE
                 PERFORM 320-PRINT-CUSTOMER-LINE
                 MOVE CUST-SALESREP TO OLD-SALESREP-NUMBER
                 MOVE CUST-BRANCH   TO OLD-BRANCH-NUMBER
              WHEN CUST-SALESREP > OLD-SALESREP-NUMBER
                 PERFORM 355-PRINT-SALESREP-LINE
                 PERFORM 320-PRINT-CUSTOMER-LINE
                 MOVE CUST-SALESREP TO OLD-SALESREP-NUMBER
              WHEN OTHER
       ...
       320-PRINT-CUSTOMER-LINE.
           ...
           IF NOT-FIRST-RECORD
              IF CUST-BRANCH > OLD-BRANCH-NUMBER
                 MOVE CUST-BRANCH TO CL-BRANCH-NUMBER
              ELSE
           ...
           IF CUST-SALESREP = OLD-SALESREP-NUMBER
              AND NOT-FIRST-RECORD
              MOVE SPACE TO CL-SALESREP-NUMBER
              MOVE SPACE TO CL-SALESREP-NAME
           ELSE
              MOVE CUST-SALESREP TO CL-SALESREP-NUMBER
              PERFORM 325-MOVE-SALESREP-NAME
           END-IF.

           MOVE CUST-NUMBER TO CL-CUSTOMER-NUMBER.
           MOVE CUST-NAME   TO CL-CUSTOMER-NAME.
           MOVE CUST-YTD-THIS-YEAR  TO CL-SALES-THIS-YTD.
           MOVE CUST-YTD-LAST-YEAR  TO CL-SALES-LAST-YTD.
           COMPUTE WS-CHANGE-AMOUNT =
              CUST-YTD-THIS-YEAR - CUST-YTD-LAST-YEAR.
           MOVE WS-CHANGE-AMOUNT TO CL-CHANGE-AMOUNT.
           IF CUST-YTD-LAST-YEAR = ZERO
              MOVE "  N/A " TO CL-CHANGE-PERCENT-R
           ELSE
              COMPUTE CL-CHANGE-PERCENT ROUNDED =
                 WS-CHANGE-AMOUNT * 100 / CUST-YTD-LAST-YEAR
                 ON SIZE ERROR
           ...
           ADD CUST-YTD-THIS-YEAR TO SALESREP-TOTAL-THIS-YTD.
           ADD CUST-YTD-LAST-YEAR TO SALESREP-TOTAL-LAST-YTD.
       ...
       325-MOVE-SALESREP-NAME.
           ...
           SEARCH SALESREP-GROUP
              ...
              WHEN SALESREP-NUMBER(SRT-INDEX) = CUST-SALESREP
