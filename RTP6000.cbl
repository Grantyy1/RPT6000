      ...
      ****************************************************************
       ...
       01  CUSTMAST-RECORD.
           ...
           05  CM-THIS-YTD-SALES      PIC 9(6)V99.
           05  CM-LAST-YTD-SALES      PIC 9(6)V99.
           05  FILLER                 PIC X(79).
       ...
       200-LOAD-SALESREP-TABLE.
           PERFORM
               ...
               UNTIL SALESREP-EOF OR SRT-INDEX = 100
                   ...
                   IF NOT SALESREP-EOF
                       MOVE SR-SALESREP-NUMBER
                           TO SALESREP-NUMBER (SRT-INDEX)
                       MOVE SR-SALESREP-NAME
       ...
       320-PRINT-CUSTOMER-LINE.
           ...
           MOVE CM-THIS-YTD-SALES   TO CL-SALES-THIS-YTD.
           MOVE CM-LAST-YTD-SALES   TO CL-SALES-LAST-YTD.
           COMPUTE WS-CHANGE-AMOUNT =
              CM-THIS-YTD-SALES - CM-LAST-YTD-SALES.
           MOVE WS-CHANGE-AMOUNT TO CL-CHANGE-AMOUNT.
           IF CM-LAST-YTD-SALES = ZERO
              MOVE "  N/A " TO CL-CHANGE-PERCENT-R
           ELSE
              COMPUTE CL-CHANGE-PERCENT ROUNDED =
                 WS-CHANGE-AMOUNT * 100 / CM-LAST-YTD-SALES
                 ON SIZE ERROR
           ...
           ADD CM-THIS-YTD-SALES TO SALESREP-TOTAL-THIS-YTD.
           ADD CM-LAST-YTD-SALES TO SALESREP-TOTAL-LAST-YTD.
